                            ...
                            <div class="col-md-8">
                                ...
                                <form action="#" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body bg-light">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <img id="output" src="<?php echo base_url(); ?>assets/collection/front/<?php echo $collectionobj["image"]?>" style="height:300px;" />
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" value="<?php echo $collectionobj["title"]?>" id="inputcom" placeholder="Enter Title Here" name='title'>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" value="<?php echo $collectionobj["access_code"]?>" name="access_code" id="inputcom" placeholder="Enter Access Code" name='attr'>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
